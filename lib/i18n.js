...
const STRINGS = Object.freeze({
  zh: Object.freeze({
    ...
    meterPeriodSpend: '本期',
    meterLifetimeSpend: '累计已用',
    meterBalance: '余额',
    meterBalanceGranted: '赠金',
    meterBalanceCharged: '充值',
    creditsUnit: 'credits',
    turnSpendApprox: '≈',
    quotaUsageTitle: '用法：',
  ...
  en: Object.freeze({
    ...
    meterLifetimeSpend: 'lifetime',
    meterBalance: 'balance',
    // Short labels for a relay's two money meters; the adapter's own english
    // labels ("gift" / "recharged") are what these replace.
    meterBalanceGranted: 'gift',
    meterBalanceCharged: 'recharged',
    creditsUnit: 'credits',
    turnSpendApprox: '≈',
...
/**
 * The strings a language actually ships, exported so a test can prove the two
 * tables never drift apart: a key present in one language and missing in the
 * other renders as the raw key on screen.
 */
export const STRING_KEYS = Object.freeze({
  zh: Object.freeze(Object.keys(STRINGS.zh)),
  en: Object.freeze(Object.keys(STRINGS.en)),
})
